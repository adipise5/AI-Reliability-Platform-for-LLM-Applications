"""Alembic migration runner. Owns migrations for the `trace_collector`
...
from trace_collector.infrastructure.models import SpanModel  # noqa: F401
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="trace_collector",
