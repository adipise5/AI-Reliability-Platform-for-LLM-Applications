"""Alembic migration runner. Owns migrations for the `hallucination`
...
from hallucination_detection.infrastructure.models import FaithfulnessCheckModel  # noqa: F401
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="hallucination",
