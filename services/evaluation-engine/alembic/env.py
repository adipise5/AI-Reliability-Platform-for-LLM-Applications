"""Alembic migration runner. Owns migrations for the `eval_engine`
...
from evaluation_engine.infrastructure.models import EvalRunModel, RunItemResultModel  # noqa: F401
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="eval_engine",
