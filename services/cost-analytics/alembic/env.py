"""Alembic migration runner. Owns migrations for the `cost_analytics`
...
from cost_analytics.infrastructure.models import BudgetModel, UsageRecordModel  # noqa: F401
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="cost_analytics",
