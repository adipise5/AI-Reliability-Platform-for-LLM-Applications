"""Alembic migration runner. Owns migrations for the `regression`
...
from regression_detection.infrastructure.models import BaselineModel, GateDecisionModel  # noqa: F401
...
def run_migrations_offline() -> None:
    context.configure(
        ...
        version_table_schema="regression",
