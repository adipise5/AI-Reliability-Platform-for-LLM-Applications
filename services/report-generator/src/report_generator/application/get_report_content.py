...
from report_generator.domain.entities import Report, ReportStatus
...
class GetReportContentUseCase:
    ...
    async def execute(self, *, org_id: UUID, report_id: UUID) -> Report:
        ...
        if report.status != ReportStatus.READY or report.content is None:
